        ...
        <div className="space-y-1">
          <button
            className={`w-full text-left px-3 py-2 rounded-md ${
              activeView === "active" ? "bg-blue-600 text-white" : "hover:bg-gray-700"
            }`}
          ...
          <button
            className={`w-full text-left px-3 py-2 rounded-md ${
              activeView === "saved" ? "bg-blue-600 text-white" : "hover:bg-gray-700"
            }`}
          ...
          <button
            className={`w-full text-left px-3 py-2 rounded-md ${
              activeView === "sessions" ? "bg-blue-600 text-white" : "hover:bg-gray-700"
            }`}
