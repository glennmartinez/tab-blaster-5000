      ...
      <div className="mb-6">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs bg-blue-500/20 text-blue-400 px-2 py-1 rounded-full">4</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-slate-400 text-sm">Design</span>
            <span className="text-xs bg-purple-500/20 text-purple-400 px-2 py-1 rounded-full">3</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-slate-400 text-sm">Research</span>
            <span className="text-xs bg-green-500/20 text-green-400 px-2 py-1 rounded-full">2</span>
          </div>
        </div>
      </div>
