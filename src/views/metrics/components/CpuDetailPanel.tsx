...
import { TabMemoryInfo } from "../../../models/SystemMetrics";
import {
  Cpu,
  ActivitySquare,
  AlertTriangle,
        ...
        <div className="space-y-3">
          ...
          {topCpuConsumers && topCpuConsumers.length > 0 ? (
            ...
            <div className="text-slate-400 text-sm">
              No tab-specific CPU data available
            </div>
          )}
        </div>
      </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-slate-700/50">
                ...
                <th className="pb-2 text-slate-400 font-medium text-sm">
                  Window
                </th>
                <th className="pb-2 text-slate-400 font-medium text-sm text-right">
                  CPU Usage
                </th>
                <th className="pb-2 text-slate-400 font-medium text-sm text-right">
                  Process ID
          ...
          <li className="flex items-start">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Media-heavy sites, video streaming, and complex web apps tend to
                use more CPU
              </p>
            </div>
          </li>
          ...
          <li className="flex items-start">
            ...
            <div>
              <p className="text-slate-300">
                Refresh tabs that have been open for a long time
              </p>
              <p className="text-xs text-slate-500 mt-1">
